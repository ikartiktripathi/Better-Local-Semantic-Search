...
//	int s = 0;
	...
	while (dict[i]!=L'>')
	{
		...
		{ // Ensure not to go beyond the vector size
...
//		std::wcout << inp_word << "----" << dict_word << std::endl;
//		std::cout << mystrcmp(inp_word,dict_word) << std::endl;
